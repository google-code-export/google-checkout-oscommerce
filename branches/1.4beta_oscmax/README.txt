GOOGLE CHECKOUT MODULE FOR osCMax 2.0 - v1.4beta1 - 08/04/2007

NOTE: This will work with osCMax 2.0 RC3.01 +
http://www.oscmax.com/projects/oscmax/

INTRODUCTION
============
The Google Checkout module for osCMax adds Google Checkout as a Checkout 
 Module within osCMax.
This will allow merchants using osCMax to offer Google Checkout as an 
 alternate checkout method.
The plugin provides Level 2 integration of Google Checkout with osCMax.
...
To get the SVN development code visit:
...
osCMax and to discuss any topics related to integration of Google Checkout 
with osCMax, go to http://www.oscmax.com/forums

Also visit the google group for this module:
http://groups.google.com/group/google-checkout-for-osc-mod-support
